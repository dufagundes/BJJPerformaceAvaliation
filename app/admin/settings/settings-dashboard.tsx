...
const settingCards = [
  ...
  },
  {
    ...
    description: "Create schools and their administrator accounts.",
  ...
  },
  {
    ...
    footer: "Build and customize school-specific evaluation scorecards.",
  ...
  {
    title: "SMS Templates",
    description: "Customize SMS messages sent to evaluators. Messages always include the magic link.",
    footer: "Edit invite, reminder, and completion messages.",
    href: "/admin/settings/sms-templates",
    icon: "feedback" as const,
  },
  {
    title: "Email Templates",
    description: "Customize email messages sent to evaluators. Messages always include the magic link.",
    footer: "Edit invite, reminder, and self-evaluation messages.",
    href: "/admin/settings/email-templates",
    icon: "feedback" as const,
  },
  {
    title: "Test Email & SMS",
    description: "Send test messages to confirm outbound email and SMS delivery.",
    footer: "Verify email and SMS configuration.",
