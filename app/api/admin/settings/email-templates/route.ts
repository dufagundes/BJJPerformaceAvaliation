...
export async function GET() {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      placeholders: {
        invitation: ["{reviewerName}", "{subjectName}", "{schoolName}", "{deadline}", "{magicLink}"],
        reminder: ["{reviewerName}", "{subjectName}", "{schoolName}", "{deadline}", "{daysRemaining}", "{magicLink}"],
        self_evaluation: ["{staffName}", "{cycleName}", "{schoolName}", "{deadline}", "{magicLink}"],
      },
    });
  } catch (error) {
